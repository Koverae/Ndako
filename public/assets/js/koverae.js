...
document.addEventListener("DOMContentLoaded", function () {
    window.ApexCharts && (new ApexCharts(document.getElementById('channel-performance-chart'), {
        chart: {
            type: "line",
            fontFamily: 'inherit',
            height: 288,
...
document.addEventListener("DOMContentLoaded", function () {
    window.ApexCharts && (new ApexCharts(document.getElementById('total-reservation-chart'), {
        chart: {
            type: "bar",
            fontFamily: 'inherit',
            height: 240,
