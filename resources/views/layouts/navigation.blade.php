...
<nav class="navbar navbar-expand-md w-100 navbar-light d-block d-print-none k-sticky">
    ...
    <div class="setting_block">
        <div class="mt-2 alert alert-warning">
            <p>⏳ Your trial will expire in {{ getRemainingTrialDays() }} days! <a href="{{ route('subscribe') }}" class=""><strong>Upgrade now</strong></a> to continue managing your properties effortlessly with Ndako’s full suite of tools</p>
        </div>
    </div>
    @endif
