          ...
          <div class="flex-grow-0 flex-shrink-0 mb-5 overflow-auto bg-white border-left d-none d-lg-block col-md-2 app-sidebar bg-view position-relative pe-1 ps-3" style=" z-index: 500;">
            <form action="./" method="get" autocomplete="off" novalidate class="sticky-top">
              ...
              <ul class="mb-4" style="margin-left: 10px;">
                <li class="w-auto p-2 rounded cursor-pointer kover-navlink text-decoration-none panel-category" style="{{ $this->dash == 'reservations' ? 'background-color: #E6F2F3 ;' : '' }} " wire:click="changeDash('reservations')">
                  {{ __('Reservations') }}
                </li>
                <li class="w-auto p-2 rounded cursor-pointer kover-navlink {{ $dash == 'properties' ? 'selected' : '' }} text-decoration-none panel-category" wire:click="changeDash('properties')">
                  {{ __('Rooms') }}
                </li>
              </ul>
              ...
              <ul class="mb-4" style="margin-left: 10px;">
                <li class="w-auto p-2 rounded cursor-pointer kover-navlink text-decoration-none panel-category" style="{{ $this->dash == 'invoicing' ? 'background-color: #E6F2F3 ;' : '' }} " wire:click="changeDash('invoicing')">
                  {{ __('Invoicing') }}
                </li>
              </ul>
              ...
              <ul class="mb-4" style="margin-left: 10px;">
                <li class="w-auto p-2 rounded cursor-pointer kover-navlink text-decoration-none panel-category" style="{{ $this->dash == 'property' ? 'background-color: #E6F2F3 ;' : '' }} " wire:click="changeDash('property')">
                  {{ __('Properties') }}
                </li>
              </ul>
