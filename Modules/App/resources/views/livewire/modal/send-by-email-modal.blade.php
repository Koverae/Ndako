                    ...
                    <div class="k_cell k_wrap_input flex-grow-1">
                        ...
                        <div class="w-75 d-flex">
                            ...
                            <a class="cursor-pointer badge rounded-pill k_web_settings_users" style="background-color: #097274;">
                                < {{ $email }} >
                                <i class="bi bi-x cancelled_icon" wire:click.prevent="removeEmail({{ $email }})" wire:target="removeEmail('{{ $email }}')" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ __('Remove') }}"></i>
                            </a>
                            @endforeach
