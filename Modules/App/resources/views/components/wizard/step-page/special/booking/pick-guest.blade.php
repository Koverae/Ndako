            ...
            <a class="card @if($this->guest) {{ $this->guest->id == $guest->id ? 'active-pick' : '' }} @endif" wire:navigate>
                <div class="d-flex">
                    ...
                    <div class="p-2 card-body text-truncate">
                        <h5 class="mb-2 card-title">{{ $guest->name }} <i class="bi bi-pencil-square" onclick="Livewire.dispatch('openModal', {component: 'channelmanager::modal.add-guest-modal', arguments: $guest->id })"></i></h5>
