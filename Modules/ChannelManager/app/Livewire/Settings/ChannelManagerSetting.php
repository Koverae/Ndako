...
{
    public $setting;
    public bool $has_room_mapping = false, $has_cut_off_times = true, $has_airbnb_integration = false, $has_bookingcom_integration = false, $has_google_hotel_integration = false, $has_website_integration = false;
    ...
    public function boxes() : array
    {
        return [
            ...
            Box::make('website-integration', "Website Integration", 'has_website_integration', "Appear directly in Google search results, syncing your availability and pricing to capture potential guests instantly.", 'integration', true, "", null),
        ];
    }
    ...
    public function inputs() : array
    {
        return [
            ...
            // Website Integration
            BoxInput::make('client-id', "Client ID", 'text', 'google_hotel_client_id', 'website-integration', '', false, [], $this->has_website_integration)->component('app::blocks.boxes.input.depends'),
            BoxInput::make('api-key', "API Key", 'text', 'google_hotel_api_key', 'website-integration', '', false, [], $this->has_website_integration)->component('app::blocks.boxes.input.depends'),
        ];
    }
