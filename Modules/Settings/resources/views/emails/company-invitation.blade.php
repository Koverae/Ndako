                                                    ...
                                                    <tr>
                                                        <td class="content" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif; padding: 40px 48px;">
                                                                        ...
                                                                        <table class="icon icon-md bg-none" cellspacing="0" cellpadding="0" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif; border-collapse: separate; width: 54px; border-radius: 50%; line-height: 100%; font-weight: 300; height: 54px; font-size: 32px; text-align: center; padding: 0;" bgcolor="transparent">
                                                                            <tr>
                                                                                <td align="center" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif;">
                                                                                    <img src="{{ asset('assets/icons-black-plus.png')}}" class=" va-middle" width="32" height="32" alt="plus" style="line-height: 100%; outline: none; text-decoration: none; vertical-align: middle; font-size: 0; display: block; border-style: none; border-width: 0;" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                            ...
                                                            <h2 class="m-0 text-center" style="font-weight: 600; color: #232b42; font-size: 24px; line-height: 130%; margin: 0;" align="center">
                                                                You have been invited to join <strong>{{ $company->name }}</strong>
                                                            </h2>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <tr>
                                                                <td class="px-sm" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif; padding-right: 8px; padding-left: 8px;">
                                                                    <a href="https://tabler.io/emails?utm_source=demo" style="color: #206bc4; text-decoration: none;">
                                                                        <img src="{{ asset('assets/icons-gray-brand-facebook.png')}}" class=" va-middle" width="24" height="24" alt="brand-facebook" style="line-height: 100%; outline: none; text-decoration: none; vertical-align: middle; font-size: 0; border-style: none; border-width: 0;" />
                                                                    </a>
                                                                </td>
                                                                <td class="px-sm" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif; padding-right: 8px; padding-left: 8px;">
                                                                    <a href="https://tabler.io/emails?utm_source=demo" style="color: #206bc4; text-decoration: none;">
                                                                        <img src="{{ asset('assets/icons-gray-brand-twitter.png')}}" class=" va-middle" width="24" height="24" alt="brand-twitter" style="line-height: 100%; outline: none; text-decoration: none; vertical-align: middle; font-size: 0; border-style: none; border-width: 0;" />
                                                                    </a>
                                                                </td>
                                                                <td class="px-sm" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif; padding-right: 8px; padding-left: 8px;">
                                                                    <a href="https://tabler.io/emails?utm_source=demo" style="color: #206bc4; text-decoration: none;">
                                                                        <img src="{{ asset('assets/icons-gray-brand-github.png')}}" class=" va-middle" width="24" height="24" alt="brand-github" style="line-height: 100%; outline: none; text-decoration: none; vertical-align: middle; font-size: 0; border-style: none; border-width: 0;" />
                                                                    </a>
                                                                </td>
                                                                <td class="px-sm" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif; padding-right: 8px; padding-left: 8px;">
                                                                    <a href="https://tabler.io/emails?utm_source=demo" style="color: #206bc4; text-decoration: none;">
                                                                        <img src="{{ asset('assets/icons-gray-brand-youtube.png')}}" class=" va-middle" width="24" height="24" alt="brand-youtube" style="line-height: 100%; outline: none; text-decoration: none; vertical-align: middle; font-size: 0; border-style: none; border-width: 0;" />
                                                                    </a>
                                                                </td>
                                                                <td class="px-sm" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif; padding-right: 8px; padding-left: 8px;">
                                                                    <a href="https://tabler.io/emails?utm_source=demo" style="color: #206bc4; text-decoration: none;">
                                                                        <img src="{{ asset('assets/icons-gray-brand-pinterest.png')}}" class=" va-middle" width="24" height="24" alt="brand-pinterest" style="line-height: 100%; outline: none; text-decoration: none; vertical-align: middle; font-size: 0; border-style: none; border-width: 0;" />
                                                                    </a>
                                                                </td>
                                                                <td class="px-sm" style="font-family: Inter, -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif; padding-right: 8px; padding-left: 8px;">
                                                                    <a href="https://tabler.io/emails?utm_source=demo" style="color: #206bc4; text-decoration: none;">
                                                                        <img src="{{ asset('assets/icons-gray-brand-instagram.png')}}" class=" va-middle" width="24" height="24" alt="brand-instagram" style="line-height: 100%; outline: none; text-decoration: none; vertical-align: middle; font-size: 0; border-style: none; border-width: 0;" />
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
