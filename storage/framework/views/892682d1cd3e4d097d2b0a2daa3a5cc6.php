...
<?php endif; ?>
                    ...
                    <div class="p-0 m-0 k_employee_avatar">
                        ...
                        <?php else: ?>
                        <img src="<?php echo e($this->image_path ? Storage::url('avatars/' . $this->image_path) . '?v=' . time() : asset('assets/images/default/'.$default_img.'.png')); ?>" alt="<?php echo e($this->image_path); ?>" title="<?php echo e($this->image_path); ?>" class="img img-fluid">
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
