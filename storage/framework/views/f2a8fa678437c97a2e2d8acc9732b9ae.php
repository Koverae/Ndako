    ...
    <div class="mb-2 table-responsive">
        <table class="table card-table table-vcenter text-nowrap datatable">
            ...
            <tbody class="bg-white ">
                <?php $__currentLoopData = $this->data(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
...
<?php endif; ?>
                ...
                ?>
                <?php if($hasSubData && in_array($row->id, $this->expandedRows)): ?>
                <tr class="expandable-row show" colspan="6">
                    <td colspan="6">
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            <thead class="list-table">
                                <tr>
                                    <?php $__currentLoopData = $this->subColumns(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tbody class="bg-white">
                                <?php $__currentLoopData = $this->subData($row->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\livewire\components\table\table.blade.php ENDPATH**/ ?>