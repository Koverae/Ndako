        ...
        <div class="gap-5 k_control_panel_main d-flex flex-nowrap justify-content-between align-items-lg-start flex-grow-1">
            ...
            <div class="gap-1 k_control_panel_breadcrumbs d-flex align-items-center order-0 h-lg-100">
                ...
                <div class="min-w-0 gap-2 k_last_breadcrumb_item active align-items-center lh-sm">
                    ...
                    <?php if($showBreadcrumbs && $filteredBreadcrumbs->isNotEmpty()): ?>
                    <span>
                        <?php $__currentLoopData = $filteredBreadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!$loop->first): ?>
                        ...
                        <div class="gap-1 k_cp_action_menus d-flex align-items-center pe-2">
                            ...
                            <div class="k_dropdown dropdown dropend lh-1 dropdown-no-caret">
                                ...
                                <div class="k_dropdown_menu dropdown-menu dropdown-menu-end">
                                    ...
                                    <?php $__currentLoopData = $this->actionButtons(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action_button): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="k_cp_switch_buttons align-items-center">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <?php $__currentLoopData = $this->actionDropdowns(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
...
<?php endif; ?>
            ...
            <div class="order-2 gap-2 d-none d-lg-inline-flex rounded-2 k_panel_control_actions_search d-flex align-items-center justify-content-between order-lg-1">
                ...
                <div class="gap-2 d-flex align-items-center">
                    ...
                    <div class="gap-2 d-flex">
                        <!-- Filters -->
                        <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <span class="cursor-pointer fs-4" style="background-color: #D8DADD;" wire:click="removeFilter('<?php echo e($key); ?>')">
                                ...
                                <?php $__currentLoopData = $valueList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <?php if(!$loop->last): ?> <span class="text-muted">or</span> <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="dropdown k_filter_search align-items-end text-end">
                    ...
                    <div class="p-3 dropdown-menu" aria-labelledby="dropdownMenu2">
                        <div class="container p-0">
                            ...
                            <?php $__currentLoopData = $filterTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="flex-wrap order-3 align-items-end k_control_panel_navigation d-flex flex-md-wrap align-items-center justify-content-end gap-l-1 gap-xl-5 order-lg-2 flex-grow-1">
                ...
                <div class="k_cp_switch_buttons d-print-none d-xl-inline-flex btn-group">
                    <!-- Button view -->
                    <?php $__currentLoopData = $this->switchButtons(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $switchButton): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\livewire\components\navbar\control-panel.blade.php ENDPATH**/ ?>