            ...
            <div class="k_form_nosheet">
                <div class="k_inner_group row">
                    <div class="col-12">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(count($unitPrices) > 0): ?>
                            <div class="row mt-2">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $unitPrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <!-- Rate Type -->
                                    <div class="mb-3 col-md-12 col-lg-4">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ["unitPrices.$i.rate_type"];
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ["unitPrices.$i.rate"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="mt-1 text-danger"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ["unitPrices.$i.default"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="mt-1 text-danger"><?php echo e($message); ?></div> <?php unset($message);
