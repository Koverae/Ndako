<?php $__env->startSection('title', $pos->name ?? 'Kitchen Display'); ?>
...
<style>
  ...
  .dropzone.drag-over::after{
    content:'<?php echo e(__("Release to move")); ?>';
...
<main
  class="relative main"
  x-data="posRoot(<?php if ((object) ('isLocked') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isLocked'->value()); ?>')<?php echo e('isLocked'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isLocked'); ?>')<?php endif; ?>.live)"
...
>
  ...
  <div
    ...
    style="z-index:99999;"
    class="fixed inset-0 <?php echo e($isLocked ? '' : 'd-none'); ?> d-flex align-items-center justify-content-center bg-opacity-75 d-print-none bg-body-secondary backdrop-blur animate-fade-in"
  ...
  >
    <div class="relative d-flex flex-column align-items-center justify-content-center w-100 h-100 bg-white">
      <div class="top-0 px-4 py-4 position-absolute start-0 end-0 d-flex justify-content-between align-items-center" style="width:100%;">
        ...
        <div>
          <img src="<?php echo e(asset('assets/images/logo/ndako.png')); ?>" alt="Ndako Logo" style="height:60px;" loading="lazy" decoding="async" />
        </div>
      </div>
      ...
      <div class="flex-grow d-flex justify-content-center align-items-center w-100">
        ...
        >
          ...
          <div><?php echo e(__('Open KDS')); ?></div>
        </button>
      </div>
    ...
    <div class="container-fluid">
      ...
      <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3 m-0">
        <a href="#" aria-label="Home">
          <img src="<?php echo e(asset('assets/images/logo/ndako.png')); ?>" class="navbar-brand-image normal" alt="Ndako" loading="lazy" decoding="async">
          <img src="<?php echo e(asset('assets/images/logo/ndako-white.png')); ?>" class="navbar-brand-image dark" alt="Ndako" loading="lazy" decoding="async">
        </a>
      </h1>
      ...
      <div class="flex-row navbar-nav order-md-last">
        <div class="d-md-flex d-flex">
          <div class="nav-item dropdown d-md-flex me-3">
            <a href="#" class="px-0 nav-link text-dark" data-bs-toggle="dropdown" id="dropdownMenuButton" title="<?php echo e(__('Translate')); ?>" data-bs-placement="bottom" aria-label="<?php echo e(__('Translate')); ?>">
              <i class="bi bi-translate" style="font-size:16px;"></i>
            </a>
          </div>

          <div class="nav-item dropdown">
            <a href="#" class="p-0 nav-link d-flex lh-1 text-reset" data-bs-toggle="dropdown" aria-label="<?php echo e(__('Open user menu')); ?>">
        ...
        <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
          <ul class="navbar-nav w-100">
            <div class="station-scroll">
              <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->stations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="cursor-pointer nav-item" data-turbolinks style="white-space:nowrap;">
                  <a class="nav-link kover-navlink <?php echo e($station === $key ? 'selected' : ''); ?> dark:text-gray-200"
                     wire:click="switchStation('<?php echo e($key); ?>')" style="margin-right:5px;">
                    <span class="nav-link-title"><?php echo e(__($label)); ?></span>
                  </a>
                </li>
              ...
              <li class="nav-item d-flex align-items-center ms-auto" style="min-width:160px">
                <select class="form-select form-select-sm" wire:model.live="sinceMins">
                  <option value="60"><?php echo e(__('Last 1h')); ?></option>
                  <option value="90"><?php echo e(__('Last 1.5h')); ?></option>
                  <option value="120"><?php echo e(__('Last 2h')); ?></option>
                  <option value="240"><?php echo e(__('Last 4h')); ?></option>
                  <option value="480"><?php echo e(__('Last 8h')); ?></option>
                </select>
              </li>
            </div>
          </ul>
  ...
  <div class="container-fluid py-3 h-screen-d overflow-y-auto d-print-none"
       x-data="kdsDnD(window.Livewire.find('<?php echo e($_instance->getId()); ?>'))"
       wire:key="kds-board"
       wire:poll.visible.2s>
    
    <div x-show="pickMode" x-transition.opacity class="kds-hint">
      <?php echo e(__('Tap a column to drop')); ?>

    </div>

    <div class="kanban" role="list" aria-label="<?php echo e(__('Kitchen tickets')); ?>">
      
      <section class="kan-col" aria-labelledby="col-new">
        <header class="kan-head">
          <div class="title" id="col-new"><?php echo e(__('New')); ?></div>
          <div class="badge-count" aria-live="polite"><?php echo e(count($queued ?? [])); ?></div>
        </header>
        <div class="kan-body dropzone"
          ...
          <!--[if BLOCK]><![endif]--><?php if(empty($queued)): ?>
            <div class="empty"><?php echo e(__('No new tickets')); ?></div>
          <?php else: ?>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $queued; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $order = $block->order; ?>
              <article class="ticket" role="listitem" draggable="true"
                       @dragstart="dragOrder(<?php echo e($order->id); ?>, $event)"
                       @dragend="dragEnd($event)"
                       @pointerdown="touchStart('order', <?php echo e($order->id); ?>, $event)"
                       @pointerup="touchEnd($event)"
                       @pointercancel="touchCancel($event)"
                       @pointerleave="touchCancel($event)"
                       wire:key="queued-order-<?php echo e($order->id); ?>">
                <div class="ticket-head">
                  <div>
                    <div class="ticket-id">#<?php echo e($order->reference ?? $order->id); ?></div>
                    <div class="ticket-sub"><?php echo e($order->table->table_name ?? __('Direct')); ?></div>
                  </div>
                  <span class="chip"><i class="bi bi-clock"></i> <?php echo e(\Carbon\Carbon::parse($order->date)->diffForHumans(null,true)); ?></span>
                </div>
                <div class="items">
                  <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $block->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item" draggable="true"
                         @dragstart="dragItem(<?php echo e($it->id); ?>, $event)"
                         @dragend="dragEnd($event)"
                         @pointerdown="touchStart('item', <?php echo e($it->id); ?>, $event)"
                         @pointerup="touchEnd($event)"
                         @pointercancel="touchCancel($event)"
                         @pointerleave="touchCancel($event)"
                         wire:key="queued-item-<?php echo e($it->id); ?>">
                      <div class="d-flex align-items-start gap-2">
                        <span class="qty"><?php echo e($it->quantity); ?></span>
                        <div>
                          <div class="name"><?php echo e($it->product->product_name ?? __('Item')); ?></div>
                          <!--[if BLOCK]><![endif]--><?php if(!empty($it->note)): ?>
                            <div class="note"><?php echo e($it->note); ?></div>
                          <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                      </div>
                      <div class="d-none d-md-block">
                        <span class="chip"><i class="bi bi-arrows-move"></i> <?php echo e(__('Drag →')); ?></span>
                      </div>
                    </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                ...
                <div class="ticket-note" x-data="{ open: false }">
                  <button type="button" class="note-toggle w-100 d-flex justify-content-between" @click="open = !open" aria-expanded="false">
                    <span class="d-flex align-items-center gap-2">
                      <span class="note-pill"><i class="bi bi-chat-dots"></i> <?php echo e(__('Note')); ?></span>
                      <span class="note-preview">
                        <?php echo e($orderNote ? Str::limit(trim($orderNote), 120) : __('No note for this ticket')); ?>
                  ...
                  <div class="note-body" x-show="open" x-transition.opacity>
                    <!--[if BLOCK]><![endif]--><?php if($orderNote): ?>
                      <?php echo e($orderNote); ?>

                    <?php else: ?>
                      <div class="note-empty"><?php echo e(__('No customer note was added for this order.')); ?></div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                  </div>
                </div>
      ...
      <section class="kan-col" aria-labelledby="col-prep">
        <header class="kan-head">
          <div class="title" id="col-prep"><?php echo e(__('Preparing')); ?></div>
          <div class="badge-count" aria-live="polite"><?php echo e(count($preparing ?? [])); ?></div>
        </header>
        <div class="kan-body dropzone"
          ...
          <!--[if BLOCK]><![endif]--><?php if(empty($preparing)): ?>
            <div class="empty"><?php echo e(__('Nothing in prep')); ?></div>
          <?php else: ?>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $preparing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $order = $block->order; ?>
              <article class="ticket" role="listitem" draggable="true"
                       @dragstart="dragOrder(<?php echo e($order->id); ?>, $event)"
                       @dragend="dragEnd($event)"
                       ...
                       @pointercancel="touchCancel($event)"
                       @pointerleave="touchCancel($event)"
                       wire:key="prep-order-<?php echo e($order->id); ?>">
                <div class="ticket-head">
                  <div>
                    <div class="ticket-id">#<?php echo e($order->reference ?? $order->id); ?></div>
                    <div class="ticket-sub"><?php echo e($order->table->table_name ?? __('Direct')); ?></div>
                  </div>
                  <span class="chip"><i class="bi bi-tools"></i> <?php echo e(__('In prep')); ?></span>
                </div>
                <div class="items">
                  <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $block->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item" draggable="true"
                         ...
                         @pointercancel="touchCancel($event)"
                         @pointerleave="touchCancel($event)"
                         wire:key="prep-item-<?php echo e($it->id); ?>">
                      <div class="d-flex align-items-start gap-2">
                        <span class="qty"><?php echo e($it->quantity); ?></span>
                        <div class="name"><?php echo e($it->product->product_name ?? __('Item')); ?></div>
                      </div>
      ...
      <section class="kan-col" aria-labelledby="col-ready">
        <header class="kan-head">
          <div class="title" id="col-ready"><?php echo e(__('Ready')); ?></div>
          <div class="badge-count" aria-live="polite"><?php echo e(count($ready ?? [])); ?></div>
        </header>
        <div class="kan-body dropzone"
          ...
          <!--[if BLOCK]><![endif]--><?php if(empty($ready)): ?>
            <div class="empty"><?php echo e(__('No plates ready')); ?></div>
          <?php else: ?>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $ready; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $order = $block->order; ?>
              <article class="ticket" role="listitem" draggable="true"
                       @dragstart="dragOrder(<?php echo e($order->id); ?>, $event)"
                       @dragend="dragEnd($event)"
                       ...
                       @pointercancel="touchCancel($event)"
                       @pointerleave="touchCancel($event)"
                       wire:key="ready-order-<?php echo e($order->id); ?>">
                <div class="ticket-head">
                  <div>
                    <div class="ticket-id">#<?php echo e($order->reference ?? $order->id); ?></div>
                    <div class="ticket-sub"><?php echo e($order->table->table_name ?? __('Direct')); ?></div>
                  </div>
                  <span class="chip"><i class="bi bi-check2-circle"></i> <?php echo e(__('Ready')); ?></span>
                </div>
                <div class="items">
                  <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $block->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item" draggable="true"
                         ...
                         @pointercancel="touchCancel($event)"
                         @pointerleave="touchCancel($event)"
                         wire:key="ready-item-<?php echo e($it->id); ?>">
                      <div class="d-flex align-items-start gap-2">
                        <span class="qty"><?php echo e($it->quantity); ?></span>
                        <div class="name"><?php echo e($it->product->product_name ?? __('Item')); ?></div>
                      </div>
                      <div class="d-none d-md-block">
                        <button class="btn btn-sm btn-success"
                                @click.prevent="$wire.moveItem(<?php echo e($it->id); ?>, 'delivered')">
                          <?php echo e(__('Bump')); ?>
                ...
                <div class="mt-2 d-flex justify-content-end">
                  <button class="btn btn-sm btn-success"
                          @click.prevent="$wire.moveOrder(<?php echo e($order->id); ?>, 'delivered')">
                    <?php echo e(__('Bump order')); ?>
...
(() => {
  ...
  const apply=(m)=>{ html.setAttribute('data-theme',m); localStorage.setItem('theme',m); if(label) label.textContent = m==='dark' ? '<?php echo e(__('Switch to Light Mode')); ?>' : '<?php echo e(__('Switch to Dark Mode')); ?>'; };
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\My Laravel Startup\ndako\Modules/Pos\resources/views/livewire/interface/kds-board.blade.php ENDPATH**/ ?>