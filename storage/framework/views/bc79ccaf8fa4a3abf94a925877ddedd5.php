...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($this->addingRowFor === $value->key): ?>
                <tr>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->columns(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <!--[if BLOCK]><![endif]--><?php if($column->table === $value->key): ?>
                            <td>
                                <!--[if BLOCK]><![endif]--><?php if($column->type === 'select'): ?>
                                    <select wire:model.defer="newRow.<?php echo e($column->key); ?>" class="form-control form-control-sm">
                                        <option value="">-- Select <?php echo e($column->label); ?> --</option>
                                ...
                                <?php else: ?>
                                    <input
                                        type="<?php echo e($column->type ?? 'text'); ?>"
                                        wire:model.defer="newRow.<?php echo e($column->key); ?>"
                    ...
                    <td class="d-flex gap-2">
                        <button wire:click.prevent="saveRow('<?php echo e($value->key); ?>')" class="btn btn-sm btn-success">
            ...
            <span class="k_field_list_row w-100">
                <td class="k_field_list">
                    <span wire:click.prevent="addRow('<?php echo e($value->key); ?>')" class=" cursor-pointer" style="color: #017E84;" href="avoid:js">
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules/App\resources/views/components/form/tab/table/simple.blade.php ENDPATH**/ ?>