                ...
                <div class="m-0 mt-3 mb-3 row justify-content-between position-relative w-100">
                    <div class="ke-title mw-75 pe-2 ps-0">
                        ...
                        <ul class="list-unstyled">
                            <p><strong><?php echo e(__('Guest Name')); ?>:</strong> <?php echo e($booking->guest->name); ?></p>
                            <p><strong><?php echo e(__('Guest(s)')); ?>:</strong> <?php echo e($booking->guests); ?> <!--[if BLOCK]><![endif]--><?php if($booking->guests > 1): ?><?php echo e(__('people')); ?><?php else: ?> <?php echo e(__('person')); ?> <?php endif; ?><!--[if ENDBLOCK]><![endif]--></p>
                            <!--[if BLOCK]><![endif]--><?php if($booking->due_amount >= 1): ?>
                            <p><strong><?php echo e(__('Amount Paid')); ?>:</strong> <?php echo e(format_currency($booking->paid_amount)); ?></p>
                            <p><strong><?php echo e(__('Due Amount')); ?>:</strong> <?php echo e(format_currency($booking->due_amount)); ?></p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <p><strong><?php echo e(__('Total Amount')); ?>:</strong> <?php echo e(format_currency($booking->total_amount)); ?></p>
                        </ul>
                    </div>
