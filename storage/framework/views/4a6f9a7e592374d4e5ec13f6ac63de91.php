...
<head>
    ...
    <title><?php echo e(current_company()->name); ?> - Your free trial period has expired!</title>
      ...
      <div class="container container-tight py-4">
        <div class="card card-md">
          <div class="card-body">
            ...
            <div class="my-4">
              <a href="<?php echo e(route('subscribe')); ?>" class="btn btn-primary text-uppercase w-100 fs-3">
                Upgrade now
              </a>
            </div>
...
<?php /**PATH D:\My Laravel Startup\ndako\resources\views/errors/trial-expired.blade.php ENDPATH**/ ?>