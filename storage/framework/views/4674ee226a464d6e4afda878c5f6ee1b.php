            ...
            <div class="gap-7 row">
                ...
                <div class="p-0 k-dash-category col-md-12 col-lg-12">
                    ...
                    <table class="k-borderless-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $bestSellingRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                ...
                <div class="p-0 k-dash-category col-md-12 col-lg-12">
                    ...
                    <table class="k-borderless-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $bestSellingRoomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
