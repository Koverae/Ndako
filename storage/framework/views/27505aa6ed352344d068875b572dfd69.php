...
<div class="setting_block">
    <div class="gap-5 p-3 app_settings_header d-md-flex d-block">
        ...
        <div class="gap-4 d-flex">
            <select id="Fiscal Localization" class="k-input">
                <option value=""></option>
                <?php $__currentLoopData = $this->frontDesks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($value); ?>" <?php echo e($this->front->id == $value ? 'selected' : ''); ?>><?php echo e($text); ?></option>
    ...
    <?php if($this->front->activeSession): ?>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\components\blocks\templates\pos-header.blade.php ENDPATH**/ ?>