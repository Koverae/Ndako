  ...
  <div class="container py-4 container-tight">
    <div class="card card-md">
      <div class="card-body">
        ...
        <form method="POST" action="<?php echo e(Route::subdomainRoute('verify.store')); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
            ...
            <div class="mt-3 text-center text-secondary">
                <?php echo e(new Illuminate\Support\HtmlString(__("It may take a minute to receive your code. Haven't received it? If not, click <a class=\"hover:underline\" href=\":url\">here</a>.", ['url' => Route::subdomainRoute('verify.resend')]))); ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Laravel Startup\koverae-saas\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>