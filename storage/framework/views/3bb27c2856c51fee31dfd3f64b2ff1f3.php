                    ...
                    <div class="k_kanban_card_content">
                        ...
                        <div class="k_kanban_details k_stack">
                            ...
                            <div class="k_header">
                                <div class="k_title">
                                    <h2 class="h2 m-0">
                                        <?php echo e($b->unit->property?->name ?? 'Hotel'); ?>

                                        <i class="bi bi-pencil-square" title="Edit hotel"></i>
                                    </h2>
                                    <span class="k_room_badge" title="Room number">
                                        <i class="bi bi-door-closed"></i> <?php echo e($b->unit->name ?? '—'); ?>

                                    </span>
                                </div>
                                <span class="k_status" data-status="<?php echo e($status); ?>">
                                    <i class="bi <?php echo e($status === 'checked-in' ? 'bi-patch-check-fill' : ($status === 'cancelled' ? 'bi-x-circle' : 'bi-circle')); ?>"></i>
                            ...
                            <div class="k_subtitle">
                                <?php echo e($b->unit->label ?? 'Room'); ?> <?php echo e($b->unit->name); ?> · <?php echo e($b->unit->unitType->name ?? 'Type'); ?> ·
                                Nightly: <strong><?php echo e(format_currency($unitPrice)); ?></strong>
                            </div>
                            ...
                            <div class="k_meta_list">
                                <div class="k_meta_item">
                                    ...
                                    <span>Check-in</span>
                                    <strong><?php echo e(optional($checkIn)->format('M d, Y') ?? '—'); ?></strong>
                                </div>
                                <div class="k_meta_item">
                                    <i class="bi bi-calendar-check"></i>
                                    <span>Check-out</span>
                                    <strong><?php echo e(optional($checkOut)->format('M d, Y') ?? '—'); ?></strong>
                                </div>
                                <div class="k_meta_item">
                                    <i class="bi bi-moon"></i>
                                    <span>Nights</span>
                                    <strong><?php echo e($nights); ?></strong>
                                </div>
                                <div class="k_meta_item">
                                    <i class="bi bi-cash-coin"></i>
                                    <span>Amount Due</span>
                                    <strong class="k_total"><?php echo e(format_currency($b->due_amount ?? 0)); ?></strong>
                                </div>
                            </div>

                            <!-- Stay progress (shown only if both dates exist) -->
                            <!--[if BLOCK]><![endif]--><?php if($checkIn && $checkOut): ?>
                                <div class="k_progress" aria-label="Stay progress">
                                    <div class="k_progress_track">
                                        <div class="k_progress_bar" style="width: <?php echo e($progress); ?>%"></div>
                                    </div>
                                    <div class="k_progress_hint"><?php echo e($checkIn->format('M d')); ?> – <?php echo e($checkOut->format('M d')); ?></div>
                                </div>
