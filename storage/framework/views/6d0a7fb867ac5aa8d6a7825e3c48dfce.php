...
<div x-data="offlineBanner()" x-init="init()" class="position-relative">
  ...
  <div x-show="flashOnline"
    ...
    <i class="bi bi-wifi"></i> <?php echo e(__('Back online')); ?>
    ...
    <div class="container-fluid d-flex flex-wrap align-items-center gap-2">
      <div class="d-flex align-items-center gap-2 flex-grow-1">
        ...
        <div class="d-flex flex-column">
          <strong class="net-title"><?php echo e(__('You’re offline')); ?></strong>
          <span class="net-subtle">
            <?php echo e(__('We’ll reconnect automatically. Some actions may be delayed.')); ?>
  ...
  <!-- Register -->
  <div
    x-data="cartStore(<?php if ((object) ('cart') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('cart'->value()); ?>')<?php echo e('cart'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('cart'); ?>')<?php endif; ?>.defer, <?php if ((object) ('isOnline') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOnline'->value()); ?>')<?php echo e('isOnline'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOnline'); ?>')<?php endif; ?>.defer, <?php echo e($pos->id); ?>)"
        x-init="init()"
            class="row <?php echo e($interface == 'register' ? '' : 'd-none'); ?> d-print-none"
                >
    <!-- Product Section -->
