                                    ...
                                    <ul>
                                        ...
                                        <li class="p-2 cursor-pointer orderline lh-sm">
                                            ...
                                            <ul>
                                                ...
                                                <li class="mt-1 price-per-unit" style="padding-left: 3px;">Cash: <?php echo e(format_currency($order->total_amount ?? 0 + $cartTax)); ?></li>
                                                <li class="mt-1 price-per-unit" style="padding-left: 3px;">Card: <?php echo e(format_currency(0)); ?></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
...
<div class="mt-2 mb-2 text-center pos-receipt-order-data d-flex fs-5">
    ...
    <div class="d-block ms-2 text-start">
        ...
        <!-- Payment -->
                    ...
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!-- Tables -->
        <div class="table-container d-print-none bg-white <?php echo e($interface == 'tables' ? '' : 'd-none'); ?> dark:bg-gray-800" style="height: 100vh;">
            ...
            <div class="p-5 overflow-y-auto table-section row h-100 ">
                ...
                <div class="floor col-md-3">
                    <div class="p-0 rounded cursor-pointer floor-table flex-column justify-content-between position-absolute dark:bg-gray-700">
                        ...
                        <button wire:click="releaseTable('<?php echo e($table->id); ?>')" class="bottom-0 m-1 btn btn-danger btn-sm position-absolute end-0 dark:bg-red-800 dark:border-red-800">
                            Release
                        </button>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
        ...
        <!-- Orders -->
        <div class="order-container d-print-none overflow-y-auto bg-white <?php echo e($interface == 'orders' ? '' : 'd-none'); ?>" style="height: 100vh;">
            <div class="p-6">
                    ...
                    <table class="w-full bg-white border border-gray-200 rounded-lg shadow-sm">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase"><?php echo e(__('Customer')); ?></th>
                            ...
                            <tr class="transition duration-150 hover:bg-gray-50">
                                ...
                                <td class="flex gap-2 px-4 py-3 text-sm">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($order->status === 'ongoing' && ($cartData['active_order_id'] ?? null) != $order->id): ?>
                                        <button wire:click="selectOrder('<?php echo e($order->id); ?>')" class="relative transition duration-150 btn btn-primary btn-sm group hover:bg-indigo-600" title="<?php echo e(__('Select this order')); ?>">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($order->status == 'ongoing'): ?>
                                        <button wire:click="confirmDelete('<?php echo e($order->id); ?>')" class="relative transition duration-150 btn btn-danger btn-sm group hover:bg-red-600" title="<?php echo e(__('Delete this order')); ?>">
                                        ...
                                        <button wire:click="printPreBill('<?php echo e($order-> receipt_number); ?>')" class="relative transition duration-150 btn btn-info btn-sm group hover:bg-blue-600" title="<?php echo e(__('Print pre-bill')); ?>">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($order->status != 'refunded' && $order->payment_status == 'paid'): ?>
                                        <button wire:click="confirmRefund('<?php echo e($order->id); ?>')" class="relative transition duration-150 btn btn-danger btn-sm group hover:bg-red-600" title="<?php echo e(__('Refund this order')); ?>">
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <button wire:click="showOrderDetails('<?php echo e($order->id); ?>')" class="relative transition duration-150 btn btn-secondary btn-sm group hover:bg-gray-600" title="<?php echo e(__('View order details')); ?>">
                                        <?php echo e(__('Details')); ?>

                                        <span class="absolute hidden px-2 py-1 text-xs text-white transform -translate-x-1/2 bg-gray-800 rounded group-hover:block -top-8 left-1/2"><?php echo e(__('View order details')); ?></span>
                                    </button>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
