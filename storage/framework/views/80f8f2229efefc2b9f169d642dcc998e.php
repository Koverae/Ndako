...
<div class="d-flex" style="margin-bottom: 8px;" wire:transition.duration.300ms>
    ...
    <div class="k_cell k_wrap_input flex-grow-1">
        ...
        <select wire:model.blur="<?php echo e($value->model); ?>" id="<?php echo e($value->model); ?>" class="k-input">
            <option value=""></option>
        ...
        <div class="d-block">
            <div class="d-flex mb-3">
                <select wire:model="<?php echo e($value->model); ?>" id="<?php echo e($value->model); ?>" class="k-input w-100">
                    <option value=""></option>
            ...
            <span class="">
                <?php $__currentLoopData = $data['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="cursor-pointer badge rounded-pill k_web_settings_users" style="color: #0E6163;">
                    <?php echo e($text); ?>

                    <i wire:click.prevent="" wire:confirm="Are you sure you want to remove <?php echo e($text); ?> ?" class="bi bi-x cancelled_icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Remove <?php echo e($text); ?>"></i>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </span>
        </div>
        ...
        <textarea wire:model="<?php echo e($value->model); ?>" class="textearea k-input p-0 m-0" placeholder="<?php echo e($value->placeholder); ?>" id="description" <?php echo e($this->blocked ? 'disabled' : ''); ?>>
            
        </textarea>
        <?php else: ?>
        <input type="<?php echo e($value->type); ?>" style="margin-left: 5px;" wire:model.blur="<?php echo e($value->model); ?>" class="p-0 k-input" placeholder="<?php echo e($value->placeholder); ?>" id="date_0" <?php echo e($this->blocked ? 'disabled' : ''); ?>>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\components\form\input\depends.blade.php ENDPATH**/ ?>