...
<div class="row justify-content-center slide-animated three">
    ...
    <div class="container text-center">
        <span class="text-black caveat" style="font-size: 25px;">Powered by <strong><a class="text-black" href="https://ndako.koverae.com?utm=ndako-booking" target="_blank">Ndako</a></strong></span>
    </div>
</div>
