                ...
                <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                    <ul class="navbar-nav">
                        <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link kover-navlink dropdown" wire:navigate href="<?php echo e(route('dashboard')); ?>" style="margin-right: 5px;">
                                    ...
                                    <div class="dropdown-menu-columns">
                                        ...
                                        <div class="dropdown-menu-column">
                                            <div class="dropend">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class=" kover-navlink dropdown-item" wire:navigate href="<?php echo e(route('properties.types.lists')); ?>">
                                                        <?php echo e(__('Property Types')); ?>

                                                    </a>
                                                    <a class=" kover-navlink dropdown-item" wire:navigate href="<?php echo e(route('properties.unit-types.lists')); ?>">
