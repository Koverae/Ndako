                ...
                <div class="m-0 mt-3 mb-3 row justify-content-between position-relative w-100">
                    <div class="ke-title mw-75 pe-2 ps-0">
                        ...
                        <ul class="list-unstyled row">
                            ...
                            <p class="mb-2 col-12 col-lg-6"><strong><?php echo e(__('Guest(s)')); ?>:</strong> <?php echo e($booking->guests); ?> <?php if($booking->guests > 1): ?><?php echo e(__('people')); ?><?php else: ?> <?php echo e(__('person')); ?> <?php endif; ?></p>
                            <?php if($booking->due_amount >= 1 && $booking->status != 'canceled'): ?>
