                ...
                <div class="d-flex" style="margin-bottom: 8px;">
                    ...
                    <div class="k_cell k_wrap_input flex-grow-1 ">
                        ...
                        <select wire:model.live="property" id="property" class="k-input">
                            ...
                            <?php $__currentLoopData = $this->propertiesOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="d-flex" style="margin-bottom: 8px;">
                    ...
                    <div class="k_cell k_wrap_input flex-grow-1 ">
                        ...
                        <select wire:model.live="unit" id="unit" class="k-input">
                            <option value=""><?php echo e(__('---- Select -----')); ?></option>
                            <?php $__currentLoopData = $this->unitsOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>"><?php echo e($text); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\components\form\tab\group\special\lease.blade.php ENDPATH**/ ?>