                ...
                <div class="d-flex col-12 <?php echo e($this->type === 'task' ? 'd-none' : ''); ?>" style="margin-bottom: 8px;">
                    ...
                    <div class="k_cell k_wrap_input flex-grow-1">
                        <select wire:model.live="reportedBy" id="" class="k-input">
                            <option value=""></option>
                            <?php $__currentLoopData = current_company()->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
