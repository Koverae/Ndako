...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" wire:model="type" required>
                        ...
                        <?php $__currentLoopData = $this->propertyTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 col-md-12">
                    <label for="floors" class="form-label h3">
                        <?php echo e(__('How many floors are we stacking?')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__errorArgs = ['propertyFloors.' . $i . '.name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__errorArgs = ['propertyFloors.' . $i . '.description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 col-md-12">
                    ...
                    <div class="row">
                        <?php $__empty_1 = true; $__currentLoopData = current_company()->amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
unset($__errorArgs, $__bag); ?>" id="amenity_<?php echo e($amenity->id); ?>" wire:model="selectedAmenity" value="<?php echo e($amenity->id); ?>">
                    ...
                    <?php $__errorArgs = ['selectedAmenity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12" style="margin-bottom: 10px;">
                                <select wire:model="country" class="k-input w-100" id="country_id_0">
                                    ...
                                    <?php $__currentLoopData = $this->countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\components\wizard\step-page\special\onboarding\add-property.blade.php ENDPATH**/ ?>