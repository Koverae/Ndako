...
<div class="row gap-1 justify-content-md-center <?php echo e($this->currentStep == $value->step ? '' : 'd-none'); ?>">
    ...
    <div class="m-3 text-center">
        <h1 class="h1"><?php echo e(__('What kind of units do we have?')); ?></h1>
    </div>
        ...
        <div class="card-body">
            <div class="m-0 mb-2 row justify-content-between position-relative w-100">
                <div class="ke-title mw-75 pe-2 ps-0">
                    <label class="h3" for="name-k"><?php echo e(__('What’s the name of this room?')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-3 col-md-12">
                <label for="capacity" class="form-label h3">
                    <?php echo e(__('How many guests can stay in this room?')); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-3 col-md-12">
                <label for="unitSize" class="form-label h3">
                    <?php echo e(__('How big is this room? (optional)')); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-3 col-md-12">
                <label for="unitFeatures" class="form-label h3">
                    <?php echo e(__('What can guests use in this room?')); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-3 col-md-12">
                <label for="unitPrice" class="form-label h3">
                    <?php echo e(__('How much do you want to charge per night?')); ?>
                ...
                <div class="input-icon">
                    ...
                    <input type="number" class="form-control <?php $__errorArgs = ['unitPrice'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="unitPrice" wire:model="unitPrice" style="width: 200px;" value="<?php echo e(old('unitPrice')); ?>">
                </div>
                <span class="text-muted"><?php echo e(__('Including taxes and charges')); ?></span>
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['unitPrice'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-3 col-md-12">
                <label for="unitSize" class="form-label h3">
                    <?php echo e(__('Show me some pictures room!')); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-3 d-flex justify-content-between">
                <span>&nbsp;</span>
                <button class="gap-1 btn btn-primary go-next text-end" wire:click="addUnit"><?php echo e(__('Add Room')); ?> <i class="fas fa-plus-circle"></i></button>
            </div>
                ...
                <div class="p-1 mb-1 cursor-pointer col-12 col-lg-4" style="min-height: 122px;">
                    <div class="p-2 border rounded" style="min-height: 122px;">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="bottom-0 text-end"><?php echo e(format_currency($unit['price'])); ?> / Night</span>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH D:\My Laravel Startup\koverae-saas\Modules/App\resources/views/components/wizard/step-page/special/property/property-unit-details.blade.php ENDPATH**/ ?>