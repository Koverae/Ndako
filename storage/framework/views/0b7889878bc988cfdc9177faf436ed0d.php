<div>
    <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
        ...
        <li class="nav-item">
            <a class="nav-link kover-navlink dropdown" wire:navigate href="<?php echo e(route('settings.general')); ?>" style="margin-right: 5px;">
              <span class="nav-link-title">
                  <?php echo e(__('Genral Settings')); ?>
