    ...
    <a class="card" wire:navigate href="<?php echo e($this->showRoute($id)); ?>">
        <div class="d-flex">
            ...
            <div class="p-2 card-body text-truncate">
                ...
                <?php $__currentLoopData = $this->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\components\table\card\simple.blade.php ENDPATH**/ ?>