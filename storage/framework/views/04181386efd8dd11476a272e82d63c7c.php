...
<div class="mt-3 ps-3">
    ...
    <span class="mt-3 d-block">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->authorizedDomains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $domain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a class="cursor-pointer badge rounded-pill k_web_settings_users">
            <?php echo e($domain); ?>

            <i wire:click.prevent="removeDomain" wire:confirm="<?php echo e(__('Are you sure you want to remove this domain?')); ?>" class="bi bi-x cancelled_icon" data-bs-toggle="tooltip" data-bs-placement="right" title="<?php echo e(__('Remove this domain')); ?>"></i>
        </a>
