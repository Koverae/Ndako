<?php $__env->startSection('page_title', 'Sign Up'); ?>
...
<?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" placeholder="eg. brianmwangi@company.com" id="email" name="email" value="<?php echo e(old('email')); ?>" required>
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
        ...
        <div class="col-lg d-none d-lg-block">
            <img src="<?php echo e(asset('assets/images/illustrations/kwame-bot/kwame-6.svg')); ?>" height="500px" class="mx-auto d-block" alt="">
        </div>
    </div>
  </div>
</div>
