...
<div>
    <!--[if BLOCK]><![endif]--><?php if($paginator->hasPages()): ?>
        <nav class="gap-2 k_pager align-items-center d-flex">
            <span class="k_page_counter">
                <!-- Page value -->
                <span class="border-transparent k_page_value d-inline-block border-bottom mb-n1">
...
<?php /**PATH D:\My Laravel Startup\koverae-saas\resources\views/vendor/livewire/k-paginate.blade.php ENDPATH**/ ?>