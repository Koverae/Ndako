        ...
        <div class="mb-4 d-block w-100">
            ...
            <span class="col-12">
                ...
                <a class="cursor-pointer badge rounded-pill k_web_settings_users" style="color: #0E6163;">
                    ...
                    <i wire:click.prevent="<?php echo e($data['delete']); ?>('<?php echo e($tax->id); ?>')" wire:confirm="Are you sure you want to remove <?php echo e($tax->name); ?> ?" class="bi bi-x cancelled_icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Remove <?php echo e($tax->name); ?>"></i>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
            </span>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules/App\resources/views/components/form/input/tag/taxes.blade.php ENDPATH**/ ?>