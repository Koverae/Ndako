...
<div class="row gap-1 justify-content-md-center <?php echo e($this->currentStep == $value->step ? '' : 'd-none'); ?>">
    ...
    <div class="m-3 text-center">
        <h1 class="h1"><?php echo e(__('Tell us about your '.$this->category.'')); ?></h1>
    </div>
                ...
                <div class="k_address_format w-100">
                    <div class="row">
                        <div class="col-12" style="margin-bottom: 10px;">
                            <input type="text" wire:model="street" id="" class="p-0 k-input w-100" placeholder="<?php echo e(__('Street 1 ....')); ?>">
                        </div>
...
<?php /**PATH D:\My Laravel Startup\koverae-saas\Modules/App\resources/views/components/wizard/step-page/special/property/property-basic-info.blade.php ENDPATH**/ ?>