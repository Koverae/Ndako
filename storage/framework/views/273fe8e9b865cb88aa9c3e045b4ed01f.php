...
<?php $__env->startSection('content'); ?>
        ...
        <div class="booking-details">
            ...
            <div class="total-amount d-block">
                <div class="mb-2"><?php echo e(__('Paid Amount')); ?>: <?php echo e($paid_amount); ?></div>
                <div class="font-bold" style="font-weight: 600;"><?php echo e(__('Total Amount')); ?>: <?php echo e($total_amount); ?></div>
            </div>
