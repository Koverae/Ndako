...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('password.store')); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" placeholder="eg. ardenbouet@koverae.com" id="email" name="email" value="<?php echo e(old('email', $request->email)); ?>" required>
...
<?php endif; ?>
            ...
            <div class="form-footer">
                <button type="submit" class="btn btn-primary w-100"><?php echo e(__('Reset Password')); ?></button>
            </div>
        </form>
      </div>
