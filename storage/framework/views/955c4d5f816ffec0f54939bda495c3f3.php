            ...
            <section class="col-lg-7 col-md-12" style="height: 100vh;" id="product-box">
                    ...
                    <div class="d-flex w-100">
                        ...
                        <div class="d-flex w-100 section_buttons cursor-pointer">
                            <span class="category_button gap-2">
                                <img class="rounded-1" src="<?php echo e(asset('assets/images/default/product.png')); ?>" height="15px"style="height: 35px;" alt="Rooms">
                                <span>Rooms</span>
                            </span>
                            <span class="category_button gap-2">
                                <img class="rounded-1" src="<?php echo e(asset('assets/images/default/product.png')); ?>" height="15px"style="height: 35px;" alt="Dining">
                                Dining
                            </span>
                            <span class="category_button gap-2">
                                <img class="rounded-1" src="<?php echo e(asset('assets/images/default/product.png')); ?>" height="15px"style="height: 35px;" alt="Amenities">
                                Amenities
                            </span>
                            <span class="category_button gap-2">
                                <img class="rounded-1" src="<?php echo e(asset('assets/images/default/product.png')); ?>" height="15px"style="height: 35px;" alt="Services">
                                Services
                            </span>
                        </div>
                    </div>
                ...
                <div class="product-list row row-cols-2 row-cols-md-3 row-cols-lg-4 gap-2 p-3">
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Deluxe Suite">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Breakfast">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <div class="badge badge-info">20</div>
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Spa Session">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Airport Transfer">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Executive Suite">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Dinner Package">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Pool Access">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Gym Session">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Conference Room">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Laundry Service">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="City Tour">
                        <div class="product-content">
                    ...
                    <article class="product">
                        ...
                        <img src="<?php echo e(asset('assets/images/default/product.png')); ?>" class="card-img-top" alt="Bar Package">
                        <div class="product-content">
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules/FrontDesk\resources/views/livewire/interface/home.blade.php ENDPATH**/ ?>