    ...
    <div class="k-form-sheet-bg">
        ...
        <form wire:submit.prevent="<?php echo e($this->form()); ?>">
            ...
            <div class="pb-2 mb-0 k-form-statusbar position-relative d-flex justify-content-between mb-md-2 pb-md-0">
                <!-- Action Bar -->
                <?php if($this->actionBarButtons()): ?>
                    <div id="action-bar" class="flex-wrap gap-1 k-statusbar-buttons d-none d-lg-flex align-items-center align-content-around">

                        <?php $__currentLoopData = $this->actionBarButtons(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
            ...
            <div class="k-form-sheet position-relative">
                ...
                <div class="gap-1 overflow-x-auto overflow-y-hidden k-horizontal-asset mb-md-3" id="k-horizontal-capsule">
                    <?php $__currentLoopData = $this->capsules(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $capsule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
...
<?php endif; ?>
                ...
                <div class="m-0 mb-2 row justify-content-between position-relative w-100">
                    <div class="ke-title mw-75 pe-2 ps-0">
                        <!-- title-->
                        <?php if(isset($this->reference) && $this->reference): ?>
                        <!-- Name -->
...
<?php endif; ?>
                    ...
                    <div class="p-0 m-0 k_employee_avatar">
                        ...
                        <div class="bottom-0 select-file d-flex position-absolute justify-content-between w100">
                            ...
                            <?php if($this->photo || $this->image_path): ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row align-items-start">
                    ...
                    <div class="k_inner_group col-lg-6">
                        <?php $__currentLoopData = $this->inputs(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $input): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($input->position == 'left' && $input->tab == 'none' && $input->group == 'none'): ?>
                                <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
<?php $component = Illuminate\View\DynamicComponent::resolve(['component' => $input->component] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dynamic-component'); ?>
...
<?php endif; ?>
                    ...
                    <div class="k_inner_group col-lg-6">
                        <?php $__currentLoopData = $this->inputs(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $input): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($input->position == 'right' && $input->tab == 'none' && $input->group == 'none'): ?>
                                <?php if (isset($component)) { $__componentOriginal511d4862ff04963c3c16115c05a86a9d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal511d4862ff04963c3c16115c05a86a9d = $attributes; } ?>
<?php $component = Illuminate\View\DynamicComponent::resolve(['component' => $input->component] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dynamic-component'); ?>
                ...
                <div class="k_group row align-items-start mt-md-0">
                    ...
                    <div class="overflow-y-auto k_inner_group k_subtotal_footer col-lg-3 right h-100">
                        ...
                        <div class="mb-1">
                            ...
                            <?php if($this->invoice->payments()->count() >= 1): ?>
                            <?php $__currentLoopData = $this->invoice->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\livewire\components\form\template\light-weight-form.blade.php ENDPATH**/ ?>