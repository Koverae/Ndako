...
<div class="mt-3 ps-3">
    ...
    <span class="mt-3 d-block">
        <?php $__currentLoopData = $this->authorizedDomains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
