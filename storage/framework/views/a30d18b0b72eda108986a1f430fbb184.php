                    ...
                    <div class="ke-title mw-75 pe-2 ps-0">
                        ...
                        <h1 class="flex-row d-flex align-items-center">
                            <select wire:model.live="selectedProperty" id="" class="form-control" id="name-k">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>"><?php echo e($text); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </select>
                            
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedProperty'];
...
unset($__errorArgs, $__bag); ?>" id="unit-floor-<?php echo e($i); ?>" wire:model="units.<?php echo e($i); ?>.floor">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($this->selectedProperty): ?>
