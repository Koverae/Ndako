        ...
        <div class="row">
            ...
            <div class="col-12" style="margin-bottom: 10px;">
                <select wire:model="country" class="k-input w-100" <?php echo e($this->blocked ? 'disabled' : ''); ?> id="country_id_0">
                    ...
                    <?php $__currentLoopData = current_company()->countries(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\components\form\input\select\address.blade.php ENDPATH**/ ?>