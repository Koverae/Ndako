...
<?php $__env->startSection('title', 'OTP Code'); ?>
                        ...
                        <table cellspacing="0" cellpadding="0" class="w-auto" align="center">
                            <tr>
                                <td class="text-center border-dashed rounded border-wide border-dark px-lg py-md">
                                    <div class="m-0 h1 font-strong"><?php echo e($two_factor_code); ?></div>
                                </td>
                            </tr>
                        </table>
                    </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My Laravel Startup\koverae-saas\resources\views/emails/otp-code.blade.php ENDPATH**/ ?>