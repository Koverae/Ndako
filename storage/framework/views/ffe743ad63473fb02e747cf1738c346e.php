    ...
    <div class="border shadow-sm col-12 col-md-8 card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <?php $__currentLoopData = $this->availableRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card <?php if($this->selectedRoom): ?> <?php echo e($this->selectedRoom->id == $room->id ? 'active-pick' : ''); ?> <?php endif; ?>">
                            <div class="card-body row">
                                <div class="col-12 col-lg-7">
                                    ...
                                    <span class="mb-3 text-muted"><?php echo e(format_currency($this->rateService->getDefaultRate($room->unitType->id)->price)); ?> / <?php echo e($this->rateService->getDefaultRate($room->unitType->id)->lease->name); ?></span>
                                    <p class="mt-2">
                ...
                <?php if($this->availableRooms->count() >= $this->perPage): ?>
