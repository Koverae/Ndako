                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="cursor-pointer">
                                    ...
                                    <td>
                                        <a class="text-decoration-none" title="<?php echo e(__('View Details')); ?>" wire:navigate href="<?php echo e(Route::subdomainRoute('bookings.show', ['booking' => $booking->id])); ?>"><i class="fas fa-info-circle fs-2" style="color: #095c5e;"></i></a>
                                        <!--[if BLOCK]><![endif]--><?php if(\Carbon\Carbon::parse($booking->check_out)->isFuture()): ?>
