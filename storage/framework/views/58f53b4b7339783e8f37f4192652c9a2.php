    ...
    <div class="page">
        <div class="header">
            <div class="header-logo">
                <img src="<?php echo e(current_company()->avatar ? Storage::url('avatars/' . current_company()->avatar) . '?v=' . time() : asset('assets/images/logo/logo-black.png')); ?>" alt="<?php echo e(current_company()->name); ?> Logo">
            </div>
            <div class="header-info">
                <h1><?php echo e(current_company()->name); ?></h1>
                <p><?php echo e(current_company()->address ?? '123 Hospitality Lane, Nairobi, Kenya'); ?></p>
                <p>Phone: <?php echo e(current_company()->phone ?? '+254 123 456 789'); ?></p>
