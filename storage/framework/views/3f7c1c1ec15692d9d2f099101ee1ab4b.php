                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="<?php echo e(config('app.url')); ?>">
                                                            <img src="<?php echo e(asset('assets/images/logo/logo-black.png')); ?>" width="116" height="34" alt="" />
                                                        </a>
                                                    </td>
                                                    <td class="text-right">
                                                    ...
                                                    <td align="center" class="pb-md">
                                                        <table class="w-auto" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td class="px-sm">
                                                                    <a href="https://tabler.io/emails?utm_source=demo">
                                                                        <img src="<?php echo e(asset('assets/images/email/icons-gray-brand-instagram.png')); ?>" class=" va-middle" width="24" height="24" alt="brand-instagram" />
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
