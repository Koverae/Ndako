        ...
        <div class="row g-3">
          ...
          <div class="flex-grow-0 flex-shrink-0 mb-5 overflow-auto bg-white border-left d-none d-lg-block col-md-2 app-sidebar bg-view position-relative pe-1 ps-3" style=" z-index: 500;">
            <form action="./" method="get" autocomplete="off" novalidate class="sticky-top">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_financial_reports')): ?>
                <header class="pt-3 form-label font-weight-bold text-uppercase"> <b><?php echo e(__('Restaurants')); ?></b></header>
                <ul class="mb-4" style="margin-left: 10px;">
                    <a  href="<?php echo e(route('dashboard', ['dash' => 'orders'])); ?>" wire:navigate>
                        <li class="w-auto p-2 rounded cursor-pointer kover-navlink text-decoration-none panel-category" style="<?php echo e($dash == 'orders' ? 'background-color: #E6F2F3 ;' : ''); ?> ">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1383642195-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1383642195-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1383642195-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1383642195-3', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1383642195-4', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1383642195-5', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1383642195-6', $__slots ?? [], get_defined_vars());
...
<?php /**PATH D:\My Laravel Startup\ndako\resources\views\livewire\dashboards\overview.blade.php ENDPATH**/ ?>