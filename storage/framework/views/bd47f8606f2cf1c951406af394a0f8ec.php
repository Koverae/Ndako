    ...
    <div class="k_inner_group col-md-6 col-lg-6">
        ...
        <div class="mb-3 d-flex">
            <div class="gap-2 k-gallery-box">
                ...
                <?php $__currentLoopData = $this->existingImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="bg-gray-200 border rounded k-image-box">
                    <img src="<?php echo e($image); ?>" class="inline-flex rounded image" alt=""title="Tooltip on top">
...
<?php /**PATH D:\My Laravel Startup\ndako\Modules\App\resources\views\components\form\tab\group\gallery-photo.blade.php ENDPATH**/ ?>