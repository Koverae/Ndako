<?php $__env->startSection('page_title', 'Join '. $invitation->company->name); ?>
  ...
  <div class="container py-4 container-tight">
    <div class="card card-md">
      <div class="card-body">
        ...
        <h2 class="mb-4 text-center h2">Join <?php echo e($invitation->company->name); ?></h2>
        <!-- Session Status -->
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('company.invitations.accept.post', $invitation->token)); ?>">
            <?php echo csrf_field(); ?>

            <div class="mb-3">
                <label class="form-label" for="name">Full Name</label>
                <input type="text" class="form-control" placeholder="eg. Brian Mwangi" id="name" name="name" value="<?php echo e(old('name')); ?>" required>
...
<?php endif; ?>
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" placeholder="eg. brianmwangi@company.com" id="email" name="email" value="<?php echo e($invitation->email); ?>" disabled>
                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" placeholder="eg. +254 712 345 678" id="phone" name="phone" value="<?php echo e(old('phone')); ?>" required>
                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
            ...
            <div class="mb-3">
                ...
                <select name="role" id="" class="form-control" disabled>
                    ...
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($role->id); ?>" <?php echo e($invitation->role == $role->name ? 'selected' : ''); ?>><?php echo e(inverseSlug($role->name)); ?></option>
...
<?php endif; ?>
            ...
            <div class="mb-1">
                <label class="text-muted fs-5" for="remember_me">
                    <span class="form-check-label">By joining <strong><?php echo e($invitation->company->name); ?></strong>, you accept our <a href="https:ndako.koverae.com/terms" target="_blank">terms and conditions</a></span>
                </label>
            </div>
            ...
            <div class="p-3 card-body">
                <div class="mt-2 text-center text-secondary">
                    Already have an account? <a href="<?php echo e(route('login')); ?>" tabindex="-1">Sign in</a>
                </div>
            </div>
        </form>
      </div>
